...
typealias FerrisGameEndBtnBlock = ()->()
typealias FerrisGameResetBtnBlock = ()->()

class FerrisGameOverView: UIView {
    ...
    var endBlock:FerrisGameEndBtnBlock?
    var resetBlock:FerrisGameResetBtnBlock?
    var showTitle:String!{
        didSet{
            self.tip.text = showTitle
            self.setNeedsLayout()
        }
    }
